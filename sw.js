const CACHE='sedori-ai-v7'; const ASSETS=['./','./index.html','./app.js','./sedori-ai.user.js','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/icon-180.png'];
